package com.yoo.common.rabbitmq.config.database;
...
public class DruidDataSourceConfig {
    private static Logger logger = LoggerFactory.getLogger(com.yoo.common.rabbitmq.config.database.DruidDataSourceConfig.class);
